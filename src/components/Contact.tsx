...
export const Contact = () => {
    ...
    const socialLinks = [
        {
          href: 'https://github.com/RandikaEdirisooriya',
        ...
        {
          href: 'https://www.linkedin.com/in/randika-edirisooriya-17a3382a3/',
          icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
          href: 'https://web.facebook.com/randika.edirisooriya',
          icon: (
            <svg
              width="24"
              height="24"
            ...
            >
              <path
                d="M22 12.073C22 6.504 17.523 2 12 2S2 6.504 2 12.073C2 17.097 5.656 21.216 10.438 22v-6.95h-3.13V12h3.13v-2.635c0-3.1 1.835-4.823 4.646-4.823 1.348 0 2.756.235 2.756.235v3.03H15.84c-1.505 0-1.97.931-1.97 1.885V12h3.348l-.534 3.05h-2.814V22C18.344 21.216 22 17.097 22 12.073z"
                fill="currentColor"
              />
            </svg>
          ),
        ...
        {
          href: 'https://www.instagram.com/randikaedirisooriya/',
    ...
    <section className="section " id='contact'>
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch reveal-up">
            <div className="mb:12 lg:mb-0 lg:flex lg:flex-col">
                ...
                Feel free to reach out anytime to discuss your project needs and explore exciting collaboration opportunities!
                </p>
            ...
            <form action="https://getform.io/f/bdrndqzb" method='POST' className='xl:pl-10 2xl:pl-20'>
              <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
              <div className="mb-4">
                <label htmlFor="name" className="label">
                Name
                </label>
                <input type="text" className="text-field" id='name' name='name' autoComplete='name' required placeholder='Randika Edirisooriya'/>
              </div>
              <div className="mb-4 ">
                <label htmlFor="email" className="label">
                Email
                </label>
                <input type="email" className="text-field" id='email' name='email' autoComplete='email' required placeholder='randikaedirisooriya@gmail.com'/>
              </div>
              </div>
              <div className="mb-4">
